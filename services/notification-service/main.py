"""
Notification Service - микросервис уведомлений и коммуникаций
Push, Email, SMS уведомления, шаблоны, статистика
"""
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        title="Lapa Notification Service",
        description="Микросервис уведомлений и коммуникаций платформы Lapa",
        version="1.0.0",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
    ...
    async def root():
        """Корневой endpoint"""
        return {
            "message": "Welcome to Lapa Notification Service",
            "version": "1.0.0",
            "docs": "/docs"
        }
