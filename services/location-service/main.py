"""
Location Service - микросервис GPS-трекинга и геолокации
Отслеживание прогулок в реальном времени, маршруты, геофенсинг
"""
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from app.services.location_tracker import LocationTracker
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        title="Lapa Location Service",
        description="Микросервис GPS-трекинга и геолокации платформы Lapa",
        version="1.0.0",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
    ...
    async def root():
        """Корневой endpoint"""
        return {
            "message": "Welcome to Lapa Location Service",
            "version": "1.0.0",
            "docs": "/docs"
        }
